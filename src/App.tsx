...
const ShootingStars = () => (
  <div className="absolute top-0 inset-x-0 h-[400px] md:h-[500px] overflow-hidden pointer-events-none z-0">
    {/* Left side stars */}
    <div className="absolute top-[10%] left-[-10%] w-[100px] md:w-[150px] h-[2px] bg-gradient-to-r from-transparent via-[#066606] to-[#4ade80] rotate-[35deg] animate-shoot" style={{ animationDelay: '0s', animationDuration: '6s' }}>
      <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[3px] h-[3px] md:w-[4px] md:h-[4px] bg-white rounded-full shadow-[0_0_10px_2px_#4ade80]" />
    </div>
    <div className="absolute top-[20%] left-[-5%] w-[150px] md:w-[200px] h-[2px] bg-gradient-to-r from-transparent via-[#066606] to-[#4ade80] rotate-[45deg] animate-shoot" style={{ animationDelay: '2s', animationDuration: '7s' }}>
      <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[3px] h-[3px] md:w-[4px] md:h-[4px] bg-white rounded-full shadow-[0_0_10px_2px_#4ade80]" />
    </div>
    <div className="absolute top-[5%] left-[10%] w-[80px] md:w-[100px] h-[2px] bg-gradient-to-r from-transparent via-[#066606] to-[#4ade80] rotate-[25deg] animate-shoot" style={{ animationDelay: '4s', animationDuration: '5s' }}>
      <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[3px] h-[3px] md:w-[4px] md:h-[4px] bg-white rounded-full shadow-[0_0_10px_2px_#4ade80]" />
    </div>
  </div>
);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 md:h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 md:gap-4">
          <button 
            ...
            className="w-8 h-8 md:w-10 md:h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/10 hover:border-[#066606]/50 transition-all overflow-hidden"
          ...
          <BeamButton className="h-8 px-3 md:h-10 md:px-6 text-xs md:text-sm !py-0">{t('bookDemo')}</BeamButton>
        </div>
      </div>
    </header>
  );
