    ...
    <div className="bg-white p-6 md:p-8 rounded-[2rem] shadow-sm border border-[#050505]/5 flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <input type="text" defaultValue={user ? user.name.split(' ')[0] : 'User'} className="w-full border border-[#050505]/10 rounded-xl px-4 py-3 bg-[#fcf6e6]/50 focus:outline-none focus:border-[#1A1A1A]/50 transition font-bold" />
        </div>
        <div>
          ...
          <input type="text" defaultValue={user ? user.name.split(' ')[1] : ''} className="w-full border border-[#050505]/10 rounded-xl px-4 py-3 bg-[#fcf6e6]/50 focus:outline-none focus:border-[#1A1A1A]/50 transition font-bold" />
        </div>
        <div className="col-span-1 sm:col-span-2">
          <label className="block text-xs font-bold text-[#050505]/50 uppercase tracking-widest mb-2">Role</label>
          <input type="text" defaultValue={user ? user.role : 'N/A'} className="w-full border border-[#050505]/10 rounded-xl px-4 py-3 bg-[#fcf6e6]/50 focus:outline-none focus:border-[#1A1A1A]/50 transition font-bold" disabled />
        </div>
        <div className="col-span-1 sm:col-span-2">
          ...
          <input type="email" defaultValue={user?.email || 'user@studentos.com'} className="w-full border border-[#050505]/10 rounded-xl px-4 py-3 bg-[#fcf6e6]/50 focus:outline-none focus:border-[#1A1A1A]/50 transition font-bold text-[#050505]/70" disabled />
        </div>
        <div className="col-span-1 sm:col-span-2">
